...
void main() {
  ...
  test('delegates request to http client and returns mapped data', () async {
    when(() => httpClient.request<List<Map<String, dynamic>>>(
          any(),
          data: any(named: 'data'),
          queryParameters: any(named: 'queryParameters'),
          method: any(named: 'method'),
        )).thenAnswer((_) => Future.value(_data));
    final cities = _data.map(CityDTO.fromMap).toList();
    final query = 'query';
    final actualCities =
        await CityRemoteDataSourceImpl(httpClient).getCities(query);
    expect(actualCities, cities);
    verify(() => httpClient.request<List<Map<String, dynamic>>>(
          '/geo/1.0/direct',
          queryParameters: {
            'q': query,
            'limit': 5,
